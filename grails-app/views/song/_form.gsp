...
<div class="fieldcontain ${hasErrors(bean: songInstance, field: 'album', 'error')} required">
	...
	<g:select id="album" name="album.id" optionValue="title" from="${com.gTunes.domain.Album.list()}" optionKey="id" required="" value="${songInstance?.album?.id}" class="many-to-one"/>
</div>
