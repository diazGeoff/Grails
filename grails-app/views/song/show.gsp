			...
			<ol class="property-list song">
				...
				<li class="fieldcontain">
					<span id="album-label" class="property-label"><g:message code="song.album.label" default="Album" /></span>
						...
						<span class="property-value" aria-labelledby="album-label"><g:link controller="album" action="show" id="${songInstance?.album?.id}">${songInstance?.album?.title}</g:link></span>
